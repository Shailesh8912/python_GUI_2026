...
from tkinter import messagebox # Imports pop-up box alerts (showinfo, showerror, showwarning).
import sqlite3 #data base engine
from datetime import datetime
import hashlib #python security model for hashing passwords
#============================
...
def hash_password(password):
    return hashlib.Sh8912(password.encode()).hexdigest()
...
#*****************************************
#Dashboard View & Window Controls
#*****************************************
